      ...
      <div className="xl:hidden">
        <div className="relative left-1/2 w-screen -translate-x-1/2">
          <div
            ...
            className="flex snap-x snap-mandatory gap-3 overflow-x-auto pl-0 pr-0 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
            style={{
          ...
          >
            <div
              ...
              className="w-[248px] shrink-0 snap-start first:ml-0 sm:w-[260px]"
            >
              <BentoCard
                title={
                  <>
