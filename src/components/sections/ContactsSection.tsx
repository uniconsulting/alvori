      ...
      <form className="mt-7 flex flex-1 flex-col gap-4">
        <Field label="Ваше имя">
          <input
            ...
            className="h-[56px] w-full rounded-[12px] bg-[var(--bg)] px-5 text-[15px] font-normal tracking-[-0.014em] text-[var(--text)] outline-none placeholder:text-[13px] placeholder:font-normal placeholder:tracking-[-0.012em] placeholder:text-[var(--text-muted)]"
            style={{ fontFamily: 'var(--font-body-text)' }}
          />
        </Field>
        ...
        <Field label="Краткое описание задачи">
          <textarea
            ...
            className="w-full flex-1 resize-none rounded-[12px] bg-[var(--bg)] px-5 py-4 text-[15px] font-normal tracking-[-0.014em] text-[var(--text)] outline-none placeholder:text-[13px] placeholder:font-normal placeholder:tracking-[-0.012em] placeholder:text-[var(--text-muted)]"
            style={{ fontFamily: 'var(--font-body-text)' }}
          />
        </Field>
        ...
        <div className="mt-2 flex flex-col gap-3">
          ...
          <Link
            href="/request"
            className="inline-flex h-[52px] items-center justify-center rounded-[12px] bg-[var(--bg)] px-6 text-[15px] font-semibold tracking-[-0.016em] text-[var(--text)]"
            style={{ fontFamily: 'var(--font-body-text)' }}
          >
